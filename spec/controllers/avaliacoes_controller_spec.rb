...
RSpec.describe AvaliacoesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all avaliacoes as @avaliacoes" do
      ...
      expect(assigns(:avaliacoes)).to eq([avaliacao])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved avaliacao as @avaliacao" do
        post :create, {:avaliacao => invalid_attributes}, valid_session
        expect(assigns(:avaliacao)).to be_a_new(Avaliacao)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested avaliacao" do
        avaliacao = Avaliacao.create! valid_attributes
        put :update, {:id => avaliacao.to_param, :avaliacao => new_attributes}, valid_session
        avaliacao.reload
    ...
    describe "with invalid params" do
      it "assigns the avaliacao as @avaliacao" do
        avaliacao = Avaliacao.create! valid_attributes
        put :update, {:id => avaliacao.to_param, :avaliacao => invalid_attributes}, valid_session
        expect(assigns(:avaliacao)).to eq(avaliacao)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the avaliacoes list" do
      avaliacao = Avaliacao.create! valid_attributes
      delete :destroy, {:id => avaliacao.to_param}, valid_session
      expect(response).to redirect_to(avaliacoes_url)
    end
  end
